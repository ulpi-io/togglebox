...
describe("Secret Validation", () => {
  ...
  describe("JWT_SECRET validation", () => {
    it("should reject placeholder pattern <GENERATE_RANDOM_STRING_MIN_32_CHARS>", () => {
      ...
      process.env["API_KEY_SECRET"] =
        "valid-secret-at-least-32-characters-long-12345";
    ...
    it("should accept strong random secret", () => {
      ...
      process.env["API_KEY_SECRET"] =
        "x9y8z7w6v5u4t3s2r1q0p9o8n7m6l5k4j3i2h1g0f9e8d7c6b5a4";
      process.env["NODE_ENV"] = "development";
  ...
  describe("API_KEY_SECRET validation", () => {
    it("should reject placeholder pattern", () => {
      process.env["JWT_SECRET"] =
        "valid-jwt-secret-at-least-32-characters-long-abc";
  ...
  describe("Stripe key validation (Cloud)", () => {
    it("should reject STRIPE_SECRET_KEY without sk_ prefix", () => {
      process.env["JWT_SECRET"] =
        "valid-jwt-secret-at-least-32-characters-long-abc";
      process.env["API_KEY_SECRET"] =
        "valid-api-key-secret-at-least-32-characters-xyz";
    ...
    it("should accept valid Stripe keys", () => {
      ...
      process.env["STRIPE_SECRET_KEY"] =
        "sk_test_51HxYz123456789abcdefghijklmnop";
      ...
      process.env["STRIPE_PRICE_ENTERPRISE_MONTHLY"] =
        "price_enterprise_monthly_123";
      process.env["STRIPE_PRICE_ENTERPRISE_YEARLY"] =
        "price_enterprise_yearly_456";
