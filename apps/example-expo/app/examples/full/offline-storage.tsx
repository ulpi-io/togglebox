    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        ...
        <TouchableOpacity
          style={[
            ...
            simulateOffline && styles.outlineButtonActive,
          ]}
        ...
        >
          <Text
            style={[
              ...
              simulateOffline && styles.outlineButtonTextActive,
            ]}
          >
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.infoText}>
          MMKV is significantly faster than AsyncStorage because it uses
          memory-mapped files with synchronous access.
        </Text>
      </View>
    </View>
  );
...
function StatusRow({
  ...
  return (
    <View style={styles.statusRow}>
      ...
      <Text style={[styles.rowValue, { color: isOk ? "#22c55e" : "#f59e0b" }]}>
        {value}
      </Text>
    </View>
  );
