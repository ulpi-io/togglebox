    ...
    <View style={styles.container}>
          ...
          renderItem={({ item }) => (
            <View style={styles.flagRow}>
              ...
              <View
                style={[
                  styles.badge,
                  item.enabled ? styles.onBadge : styles.offBadge,
                ]}
              >
                <Text
                  style={[styles.badgeText, item.enabled && styles.badgeTextOn]}
                >
                  {item.enabled ? "ON" : "OFF"}
                </Text>
              </View>
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.infoText}>
          With pollingInterval enabled, changes made in your dashboard appear
          here automatically.
        </Text>
      </View>
    </View>
