      ...
      {showFeature ? (
        ...
        <View style={styles.oldFeatureCard}>
          ...
          <Text style={styles.oldFeatureText}>
            This is the standard dashboard shown when the feature flag is disabled.
          </Text>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  newFeatureCard: { backgroundColor: '#f0fdf4', borderWidth: 1, borderColor: '#86efac', padding: 20, borderRadius: 12, marginBottom: 16 },
  oldFeatureCard: { backgroundColor: '#f9fafb', borderWidth: 1, borderColor: '#e5e7eb', padding: 20, borderRadius: 12, marginBottom: 16 },
  featureEmoji: { fontSize: 32, marginBottom: 8 },
  newFeatureTitle: { fontSize: 18, fontWeight: '600', color: '#166534', marginBottom: 8 },
  oldFeatureTitle: { fontSize: 18, fontWeight: '600', color: '#374151', marginBottom: 8 },
  newFeatureText: { fontSize: 14, color: '#15803d', lineHeight: 20 },
  oldFeatureText: { fontSize: 14, color: '#6b7280', lineHeight: 20 },
  statusCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#f9fafb', padding: 14, borderRadius: 8, borderWidth: 1, borderColor: '#e5e7eb' },
