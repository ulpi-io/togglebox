    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity
            ...
            onPress={() => setSimulatedError("network")}
          >
            <Text style={styles.simButtonText}>Network</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.simButton}
            onPress={() => setSimulatedError("auth")}
          >
            <Text style={styles.simButtonText}>Auth 401</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.simButton}
            onPress={() => setSimulatedError("rate_limit")}
          >
      ...
      <View style={styles.tipCard}>
        ...
        <Text style={styles.tipText}>
          With persistToStorage enabled, your app keeps working with cached data
          even when offline.
        </Text>
      </View>
    </View>
