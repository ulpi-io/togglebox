  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.successButton} onPress={handlePurchase} disabled={loading}>
          {loading ? (
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#f9fafb', padding: 16, borderRadius: 8, marginBottom: 12, borderWidth: 1, borderColor: '#e5e7eb' },
  ...
  successButton: { backgroundColor: '#10b981', padding: 14, borderRadius: 8, alignItems: 'center' },
  buttonText: { color: '#fff', fontWeight: '600', fontSize: 16 },
  resultCard: { backgroundColor: '#f0fdf4', padding: 14, borderRadius: 8, borderWidth: 1, borderColor: '#86efac' },
