...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#eff6ff', padding: 16, borderRadius: 8, marginBottom: 16, borderWidth: 1, borderColor: '#bfdbfe' },
  ...
  expRow: { flexDirection: 'row', justifyContent: 'space-between', padding: 12, backgroundColor: '#f9fafb', borderRadius: 8, marginBottom: 8 },
