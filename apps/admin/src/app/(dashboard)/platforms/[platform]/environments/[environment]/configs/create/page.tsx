...
interface CreateConfigPageProps {
  params: Promise<{
    platform: string;
    environment: string;
  }>;
...
export default function CreateConfigPage({ params }: CreateConfigPageProps) {
    ...
    <div>
      <div className="mb-8">
        <div className="flex items-center justify-between">
          ...
          <Link href={`/platforms/${initialPlatform}/environments/${initialEnvironment}/configs`}>
