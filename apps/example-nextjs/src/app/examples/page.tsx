...
const fullExamples = [
  {
    ...
    description: "Full pattern with loading states and error handling",
    icon: "🔀",
  },
  {
    href: "/examples/full/ab-test-cta",
    title: "A/B Test CTA",
    description: "Complete A/B test with impression and conversion tracking",
    icon: "🎯",
  },
  {
    href: "/examples/full/config-theme",
    title: "Config-Driven Theme",
    description: "Dynamic theming from remote configuration",
    icon: "🎨",
  },
  {
    href: "/examples/full/error-handling",
    title: "Error Handling",
    description: "Graceful errors with retry and cached fallback",
    icon: "⚠️",
  },
  {
    href: "/examples/full/polling-updates",
    title: "Polling Updates",
    description: "Live config and flag updates",
    icon: "🔄",
  },
  {
    ...
    <div className="min-h-screen p-8 max-w-4xl mx-auto">
      <header className="mb-8">
        ...
        <p className="text-gray-600">
          Copy-paste ready examples for the ToggleBox SDK.
        </p>
      </header>
